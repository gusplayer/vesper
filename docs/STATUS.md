...
| Arranque: splash de tinta lisa y `BootReveal` que la disuelve hasta la marca (ADR-0028) | real | real | Simulador iPhone 17 Pro, dev client nuevo, video del arranque en frío cuadro a cuadro: splash negro liso, disolución de los bordes al centro, marca sola, fade a Focus. Android: recursos regenerados por prebuild, sin correr en el emulador. Sin verificar "Reducir movimiento" |
