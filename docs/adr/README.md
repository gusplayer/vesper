...
| 0034 | La llave: una sesión profunda que abre y cierra otra persona escaneando un código que rota cada 30 s, verificado sin red; el código es un QR dibujado como campo de puntos; la cámara entra como capacidad y revierte esa parte del 0021; quien tiene la llave lee un recibo en persona al desbloquear, no un panel remoto, y el conteo de intentos queda fuera de la v1 | aceptada |
| 0035 | La llave en una página web (fase 2 del 0034, sin implementar): la página muestra el código pero nunca guarda el secreto, el teléfono sigue verificando sin red, emparejar exige una tabla efímera y un límite de intentos que el servidor no tiene, y una llave web nunca puede ser la única llave | propuesta |
