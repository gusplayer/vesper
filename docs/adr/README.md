...
Las decisiones no se editan: se marcan como superadas por un ADR nuevo.

| # | Decisión | Estado |
|---|---|---|
| 0001 | Expo con dev client, no Expo Go | aceptada |
| 0002 | Local-first con SQLite, sin backend | aceptada |
| 0003 | El bloqueo se difiere a fase 2 | aceptada |
...
| 0010 | El renglón `sin registrar` no suma monedas: resta intervalos | propuesta |
