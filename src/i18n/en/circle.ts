...
export const circle: typeof shape = {
  ...
  invite: {
    title: 'Invite',
    yourCode: 'YOUR CODE',
    yourCodeHint: 'Whoever types it into their Vesper joins your circle.',
    share: 'Share code',
    shareMessage: (code) => `Join my circle on Vesper with the code ${code}.`,
    codeField: 'Code',
    ...
    invitedYou: 'invited you to their circle',
    accept: 'Accept',
    decline: 'Decline',
    ...
    prototypeNote: 'In the prototype nobody receives the invitation.',
  },
  settings: {
    title: 'Circle',
    profile: 'Profile',
